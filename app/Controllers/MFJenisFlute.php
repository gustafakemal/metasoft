...
class MFJenisFlute extends BaseController
{
    ...
    public function apiGetAll(): ResponseInterface
	{
		...
		foreach ($query as $key => $value) {
			...
			$hapus = '<a class="btn btn-danger btn-sm" href="' . site_url('jenisflute/delete/' . $value->id) . '" data-id="' . $value->id . '" onclick="return confirm(\'Apa Anda yakin menghapus data ini?\')" title="Hapus"><i class="fas fa-trash-alt"></i></a>';
