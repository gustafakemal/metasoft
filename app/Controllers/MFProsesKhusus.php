...
class MFProsesKhusus extends BaseController
{
     ...
     * @throws \Exception
     *
     * Endpoint GET /api/master/khusus
     */
    public function apiGetAll(): ResponseInterface
	{
		...
		foreach ($query as $key => $value) {
			...
			$hapus = '<a class="btn btn-danger btn-sm" href="' . site_url('proseskhusus/delete/' . $value->id) . '" data-id="' . $value->id . '" onclick="return confirm(\'Apa Anda yakin menghapus data ini?\')" title="Hapus"><i class="fas fa-trash-alt"></i></a>';
     ...
     * @throws \Exception
     *
     * Endpoint GET /api/master/khusus/$1
     */
     ...
     * @throws \Exception
     *
     * Endpoint POST /api/master/khusus
     */
     ...
     * @throws \Exception
     *
     * Endpoint PUT /api/master/khusus
     */
