...
class MFProsesManual extends BaseController
{
	...
	public function apiGetAll()
	{
		...
		foreach ($query as $key => $value) {
			...
			$hapus = '<a class="btn btn-danger btn-sm" href="' . site_url('mfprosesmanual/delete/' . $value->id) . '" data-id="' . $value->id . '" onclick="return confirm(\'Apa Anda yakin menghapus user ini?\')" title="Hapus"><i class="fas fa-trash-alt"></i></a>';
