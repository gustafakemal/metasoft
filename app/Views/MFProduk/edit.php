...
<form name="csc-form" class="csc-form show edit-produk-form">
	...
	<div class="row">
        ...
        <div class="col-6">
            <div class="form-group row">
                <label for="sales" class="col-lg-4 col-sm-12 col-form-label">Sales <span class="text-danger">*</span></label>
                <div class="col-lg-8 col-sm-12">
	...
	<div class="row">
        <div class="col-6">
            <div class="form-group row">
                <label for="customer" class="col-lg-4 col-sm-12 col-form-label">Pelanggan <span class="text-danger">*</span></label>
                <div class="col-lg-8 col-sm-12">
        ...
        <div class="col-6">
            <div class="form-group row">
                <label for="contact_person" class="col-lg-4 col-sm-12 col-form-label">Contact Person <span class="text-danger">*</span></label>
                <div class="col-lg-8 col-sm-12">
	...
	<div class="form-group row">
		<label for="tujuan_kirim" class="col-lg-2 col-sm-12 col-form-label">Tujuan Kirim <span class="text-danger">*</span></label>
