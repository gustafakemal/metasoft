					...
					<div class="row">
						<div class="col">
							<div class="form-group">
								<label for="nama">Adhesive <span class="text-danger">*</span></label>
								<input name="nama" type="text" class="form-control" id="nama">
							</div>
							<div class="form-group">
								<label for="konstanta">Konstanta <span class="text-danger">*</span></label>
								<input name="konstanta" type="number" class="form-control" id="konstanta" value="0" min="0" step="0.01">
							</div>
							<div class="form-group">
								<label for="hargaadhesive">Harga Adhesive<span class="text-danger">*</span></label>
								<input name="hargaadhesive" type="number" class="form-control" id="hargaadhesive" value="0" min="0">
							</div>
							<div class="form-group">
								<label for="hargasolvent">Harga Solvent<span class="text-danger">*</span></label>
								<input name="hargasolvent" type="number" class="form-control" id="hargasolvent" value="0" min="0">
							</div>
							<div class="form-group">
				...
				<div class="row">
					<div class="col">
						...
						<div class="item">
							...
							<div class="custDet konstanta"></div>
						</div>
						<div class="item">
							<label>Harga Adhesive</label>
							<div class="custDet hargaadhesive"></div>
						</div>
						<div class="item">
							<label>Harga Solvent</label>
							<div class="custDet hargasolvent"></div>
						</div>
						<div class="item">
							<label>Status</label>
