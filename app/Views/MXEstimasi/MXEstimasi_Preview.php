        ...
        <div class="col-6">
            <div class="form-group row">
                ...
                <div class="col-lg-8 col-sm-12">
                    <input value="<?= $noprospek;?>" disabled type="text" class="form-control" id="no_prospek" value="" name="NoProspek">
                </div>
            </div>
        </div>
        <div class="col-6">
            <div class="form-group row">
                ...
                <div class="col-lg-2 col-sm-12">
                    <input value="<?= $alt;?>" disabled type="number" class="form-control" id="alt" name="Alt">
                </div>
            </div>
        </div>
    </div>
