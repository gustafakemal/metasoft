...
<div class="form-group row">
    ...
    <div class="col-lg-10 col-sm-12">
        <input type="text" class="form-control mandatory" id="namaproduk" value="<?= old('NamaProduk');?>"
...
<div class="row">
    <div class="col-12">
        <div class="form-group row">
            ...
            <div class="col-lg-10 col-sm-12">
                <select id="pemesan" name="Pemesan" class="form-control mandatory">
...
<div class="row">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-7 col-sm-12">
                <div style="display: flex">
                    <select id="jenisproduk" name="JenisProduk" class="form-control mr-1 mandatory">
                        <option value="">Pilih</option>
                    ...
                    <button data-toggle="modal" data-target="#dbProduk" type="button" class="btn btn-sm btn-light"
                        title="Cari produk terkait"><i class="fas fa-search"></i></button>
                </div>
            </div>
        </div>
    </div>
    <div class="col-4">
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-sm-12">
                <select id="segmen" name="Segmen" class="form-control mandatory">
                    <option value="">Pilih</option>
    ...
    <div class="col-3">
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-sm-12">
                <select id="konten" name="Konten" class="form-control mandatory">
                    <option value="">Pilih</option>
...
<div class="form-group row">
    ...
    <div class="col-sm-2">
        <input type="number" step="any" class="form-control" id="lebar" value="<?= old('Lebar');?>" name="Lebar"
            placeholder="Lebar">
    </div>
    <div class="col-sm-2">
        <input type="number" step="any" class="form-control" id="panjang" value="<?= old('Panjang');?>" name="Panjang"
            placeholder="Tinggi">
    </div>
    <div class="col-sm-5">
...
<div class="form-group row">
    ...
    <div class="col-sm-2">
        ...
        <input type="number" value="<?= old('TebalMat1');?>" step="any" class="form-control mt-1" id="tebalmat1"
            name="TebalMat1" placeholder="Tebal">
    </div>
    <div class="col-sm-2">
        <?php echo $material_form('Material2');?>
        <input type="number" value="<?= old('TebalMat2');?>" step="any" class="form-control mt-1" id="tebalmat2"
            name="TebalMat2" placeholder="Tebal">
    </div>
    <div class="col-sm-2">
        <?php echo $material_form('Material3');?>
        <input type="number" step="any" class="form-control mt-1" value="<?= old('TebalMat3');?>" id="tebalmat3"
            name="TebalMat3" placeholder="Tebal">
    </div>
    <div class="col-sm-2">
        <?php echo $material_form('Material4');?>
        <input type="number" step="any" class="form-control mt-1" value="<?= old('TebalMat4');?>" id="tebalmat4"
            name="TebalMat4" placeholder="Tebal">
    </div>
</div>
    ...
    <div class="col-4">
        <div class="form-group row">
            ...
            <div class="col-lg-6 col-sm-12">
                <input type="number" value="<?= old('Warna');?>" class="form-control" id="warna" name="Warna"
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-7 col-sm-12">
                <select id="eyemark" name="Eyemark" class="form-control">
                    <option<?= (old('Eyemark') && old('Eyemark') == '1') ? ' selected' : '';?> value="1">Eyemark Only
                        </option>
                        <option<?= (old('Eyemark') && old('Eyemark') == '2') ? ' selected' : '';?> value="2">Eyemark &
                            Block Color</option>
                </select>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-sm-12">
                <select id="rolldirection" name="RollDirection" id="rolldirection" class="form-control">
                    <option<?= (old('RollDirection') && old('RollDirection') == 'Y') ? ' selected' : '';?> value="Y">
                        Terbaca</option>
                        <option<?= (old('RollDirection') && old('RollDirection') == 'T') ? ' selected' : '';?>
                            value="T">Tidak Terbaca</option>
                </select>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-10 col-sm-12">
        ...
        <div class="prospek_jumlah-order">
            ...
            <div class="btn--nav mr-3">
                <button type="button" class="btn btn-sm btn-primary add-jml"><i class="fas fa-plus-circle"></i></button>
            </div>
            <div class="jml-val-child"></div>
        </div>

        <div class="prospek_moq">
            <div class="input--moq mr-1 mb-1" id="moq-0">
                <div class="input-group">
                    <input type="number" class="form-control form-control-sm" name="Moq" placeholder="MOQ">
                </div>
            </div>
            <div class="btn--nav mr-3">
                <button type="button" class="btn btn-sm btn-primary add-moq"><i class="fas fa-plus-circle"></i></button>
            </div>
...
<div class="row">
    <div class="col-4">
        <div class="form-group row">
            ...
            <div class="col-lg-6 col-sm-12">
                <input id="toleransi" value="<?= old('Toleransi');?>" name="Toleransi" type="number"
                    class="form-control">
            </div>
        </div>
    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-sm-12">
                <select id="filling" name="OpenForFilling" class="form-control">
                    <option value="">Pilih</option>
                    <option<?= (old('OpenForFilling') && old('OpenForFilling') == 'T') ? ' selected' : '';?> value="T">
                        Top</option>
                        <option<?= (old('OpenForFilling') && old('OpenForFilling') == 'Y') ? ' selected' : '';?>
                            value="B">Bottom</option>
                </select>
            </div>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-4">
        <div class="form-group row">
            ...
            <div class="col-lg-7 col-sm-12">
                <select id="area" name="Area" class="form-control mandatory">
                    <option value="">Pilih</option>
    ...
    <div class="col-4">
        <div class="form-group row">
            ...
            <div class="col-lg-4 col-sm-12">
                <input value="<?= old('Kapasitas');?>" id="kapasitas" name="Kapasitas" type="number"
