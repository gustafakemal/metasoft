...
echo form_open($form_action);?>
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10 col-sm-12">
            <input<?= ($copyprospek == 1) ? '' : ' disabled';?> type="text" class="form-control" id="namaproduk" value="<?= $data->NamaProduk;?>" name="NamaProduk" style="text-transform: uppercase">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-6">
            <div class="form-group row">
                ...
                <div class="col-lg-8 col-sm-12">
                    <select<?= ($copyprospek == 1) ? '' : ' disabled';?> id="pemesan" name="Pemesan" class="form-control">
        ...
        <div class="col-6">
            <div class="form-group row">
                ...
                <div class="col-lg-8 col-sm-12">
                    <select<?= ($copyprospek == 1) ? '' : ' disabled';?> id="jenisproduk" name="JenisProduk" class="form-control">
                        <option value="">Pilih</option>
	...
	<div class="row">
        <div class="col-6">
            <div class="form-group row">
                ...
                <div class="col-lg-8 col-sm-12">
                    <select<?= ($copyprospek == 1) ? '' : ' disabled';?> id="segmen" name="Segmen" class="form-control">
                        <option value="">Pilih</option>
        ...
        <div class="col-6">
            <div class="form-group row">
                ...
                <div class="col-lg-8 col-sm-12">
                    <select<?= ($copyprospek == 1) ? '' : ' disabled';?> id="konten" name="Konten" class="form-control">
                        <option value="">Pilih</option>
