    ...
    <div class="col-6">
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-sm-12">
                <input type="text" class="form-control" id="no_prospek" value="<?= $data->NoProspek;?>" name="NoProspek"
                    readonly>
            </div>
        </div>
    </div>
...
<div class="form-group row">
    ...
    <div class="col-lg-10 col-sm-12">
        <input type="text" class="form-control" id="namaproduk" value="<?= old('NamaProduk') ?: $data->NamaProduk;?>"
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-sm-12">
                <select id="pemesan" name="Pemesan" class="form-control">
                    ...
                    <option<?= $selectbox(old('Pemesan'), $customer->NoPemesan, $data->Pemesan);?>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-sm-12">
                <select id="jenisproduk" name="JenisProduk" class="form-control">
                    ...
                    <option<?= $selectbox(old('JenisProduk'), $jp->id, $data->JenisProduk);?> value="<?= $jp->id;?>">
                        <?= $jp->nama;?></option>
                        <?php endforeach;?>
                </select>
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-sm-12">
                <select id="segmen" name="Segmen" class="form-control">
                    ...
                    <option<?= $selectbox(old('Segmen'), $segmen->ID, $data->Segmen);?> value="<?= $segmen->ID;?>">
                        <?= $segmen->Nama;?></option>
                        <?php endforeach;?>
                </select>
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-sm-12">
                <select id="konten" name="Konten" class="form-control">
                    ...
                    <option<?= $selectbox(old('Konten'), $kt->ID, $data->Konten);?> value="<?= $kt->ID;?>">
                        <?= $kt->Nama;?></option>
                        <?php endforeach;?>
                </select>
            </div>
...
<div class="form-group row">
    ...
    <div class="col-sm-2">
        <input value="<?= old('Lebar') ?: $data->Lebar;?>" type="number" step="any" class="form-control" id="lebar"
            name="Lebar" placeholder="Lebar">
    </div>
    <div class="col-sm-2">
        <input value="<?= old('Panjang') ?: $data->Panjang;?>" type="number" step="any" class="form-control"
            id="panjang" name="Panjang" placeholder="Tinggi">
    </div>
    <div class="col-sm-5">
...
<div class="form-group row">
    ...
    <div class="col-sm-2">
        <select id="material1" step="any" name="Material1" class="form-control">
            ...
            <option<?= $selectbox(old('Material1'), $mt->id, $data->Material1);?> value="<?= $mt->id;?>">
                <?= $mt->nama;?></option>
                <?php endforeach;?>
        </select>
    ...
    <div class="col-sm-2">
        <select id="material2" name="Material2" class="form-control">
            <option value="">Pilih</option>
            <?php foreach ($material as $key => $mt) : ?>
            <option<?= $selectbox(old('Material2'), $mt->id, $data->Material2);?> value="<?= $mt->id;?>">
                <?= $mt->nama;?></option>
                <?php endforeach;?>
        </select>
    ...
    <div class="col-sm-2">
        <select id="material3" name="Material3" class="form-control">
            <option value="">Pilih</option>
            <?php foreach ($material as $key => $mt) : ?>
            <option<?= $selectbox(old('Material3'), $mt->id, $data->Material3);?> value="<?= $mt->id;?>">
                <?= $mt->nama;?></option>
                <?php endforeach;?>
        </select>
    ...
    <div class="col-sm-2">
        <select id="material4" name="Material4" class="form-control">
            <option value="">Pilih</option>
            <?php foreach ($material as $key => $mt) : ?>
            <option<?= $selectbox(old('Material4'), $mt->id, $data->Material4);?> value="<?= $mt->id;?>">
                <?= $mt->nama;?></option>
                <?php endforeach;?>
        </select>
    ...
    <div class="col-4">
        <div class="form-group row">
            ...
            <div class="col-lg-6 col-sm-12">
                <input value="<?= old('Warna') ?: $data->Warna;?>" type="number" class="form-control" id="warna"
                    name="Warna" placeholder="Jumlah Warna">
            </div>
        </div>
    </div>
    <div class="col-4">
...
<div class="form-group row">
    ...
    <div class="col-lg-10 col-sm-12">
        <input value="<?= old('Catatan') ?: $data->Catatan;?>" type="text" class="form-control" id="catatan"
            name="Catatan">
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-lg-10 col-sm-12">
        <input value="<?= old('Keterangan') ?: $data->Keterangan;?>" id="keterangan" name="Keterangan" type="text"
            class="form-control">
    </div>
</div>
...
<div class="row">
    <div class="col-6">
        <div class="row">
            ...
            <div class="col-lg-8 col-sm-12">
                <input value="<?= old('MaxJoin') ?: $data->MaxJoin;?>" type="number" class="form-control" id="maxjoin"
                    name="MaxJoin">
            </div>
        </div>
    </div>
    <div class="col-6">
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-sm-12">
                <input value="<?= old('WarnaTape') ?: $data->WarnaTape;?>" type="text" class="form-control"
                    id="warnatape" name="WarnaTape">
            </div>
        </div>
    </div>
</div>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-sm-12">
                <select id="bagmaking" name="BagMaking" class="form-control">
                    ...
                    <option<?= $selectbox(old('BagMaking'), $bm->ID, $data->BagMaking);?> value="<?= $bm->ID;?>">
                        <?= $bm->Nama;?></option>
                        <?php endforeach;?>
                </select>
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-sm-12">
                <select id="bottom" name="Bottom" class="form-control" disabled>
                    ...
                    <option<?= $selectbox(old('Bottom'), $bt->ID, $data->Bottom);?> value="<?= $bt->ID;?>">
                        <?= $bt->Nama;?></option>
                        <?php endforeach;?>
                </select>
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-7 col-sm-12">
                <select id="area" name="Area" class="form-control">
                    ...
                    <option<?= $selectbox(old('Area'), $a_k->ID, $data->Area);?> value="<?= $a_k->ID;?>">
                        <?= $a_k->Nama;?></option>
                        <?php endforeach;?>
                </select>
            </div>
    ...
    <div class="col-4">
        <div class="form-group row">
            ...
            <div class="col-lg-4 col-sm-12">
                <input value="<?= old('Kapasitas') ?: $data->Kapasitas;?>" id="kapasitas" name="Kapasitas" type="number"
