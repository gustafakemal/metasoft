...
$(function () {
	...
	const config = {
		...
		createdRow: ['No', 'Tanggal dibuat', 'Jenis Flute', 'Harga', 'Status Aktif', 'Action'],
	...
	const datatable = new Datatable('#dataList', config, `${HOST}/jenisflute/api`, 'GET')
	datatable.load()
